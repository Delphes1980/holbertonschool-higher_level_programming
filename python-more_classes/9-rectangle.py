...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        # Increment when an instance is created
    ...
    # Del an instance of the Rectangle class
    def __del__(self):
        print("Bye rectangle...")

        # Decremente when an instance is deleted
        type(self).number_of_instances -= 1

    @staticmethod
    def bigger_or_equal(rect_1, rect_2):
        """
        Returns the biggest rectangle between rect_1 and rect_2
        based on the area

        Note:
        bigger_or_equal is a static method

        Returns:
        rect_1 if both have the same area value
        """

        # Checks if rect_1 is an instance of the class Rectangle
        if not isinstance(rect_1, Rectangle):
            raise TypeError("rect_1 must be an instance of Rectangle")

        # Checks if rect_2 is an instance of the class Rectangle
